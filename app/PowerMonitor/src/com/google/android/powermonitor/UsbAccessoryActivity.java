...
public final class UsbAccessoryActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        dataServiceIntent.putExtra(DataService.SIMULATE, false);
        startService(dataServiceIntent);

        // Start power monitor activity
        //Intent powerMonitorIntent = new Intent(this,PowerMonitorData.class);
        //startActivity(powerMonitorIntent);
